...
abstract class MeetingDao {
  ...
  @Query('UPDATE $MEETING_TABLE_NAME SET transcriptionId = :transcriptionId WHERE id = :id')
  Future<void> updateTranscriptionIdMeetingById(String id, String transcriptionId);
